...
/**
 * Terraform format security resource.
 */
@Named
@Singleton
public class TerraformFormatSecurityContributor
    extends RepositoryFormatSecurityContributor
{
  @Inject
  public TerraformFormatSecurityContributor(@Named(TerraformFormat.NAME) final Format format) {
    super(format);
  }
}
